...
export default function WhatsAppWidget() {
  // Format the phone number to remove spaces and special characters for the wa.me link
  const formattedPhone = legalContent.contact.phone.replace(/[^0-9]/g, '');
  
  // Pre-fill a professional message
  const message = encodeURIComponent("Hello, I am looking for a legal consultation. Please guide me.");
